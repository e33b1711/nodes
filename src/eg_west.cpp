...
#ifndef __TEST__
uint8_t mac[] = {0xDE, 0xBB, 0x7E, 0xE1, 0xCC, 0x03};
#else
...
thermos_t thermos[num_thermos] = {
        {"EG_GA", "V_EG_GA", 120, 0.2, 22, 0.0, 0},
        {"EG_KU", "V_EG_KU", 120, 0.2, 22, 0.0, 0},
        {"EG_WZ", "V_EG_WZ", 120, 0.2, 21, 0.0, 0},
        {"EG_EZ", "V_EG_EZ", 120, 0.2, 22, 0.0, 0},
};
