...
void user_logic() {
  long_short(15, 3, "LI_OG_GA_L1", "LI_OG_GA");
  long_short(13, 0, "DF_OG_GA", "VD_OG_GA");
  long_short(10, 100, "DF_OG_GA", "VD_OG_GA");
  long_short(1, 3, "LI_OG_GA_L1", "LI_OG_GA");
  simple(14, 3, "LI_OG_KN");
  simple(9, 3, "LI_OG_KN_L1");
  long_short(11, 100, "DF_OG_KN", "VD_OG_KN");
  long_short(8, 0, "DF_OG_KN", "VD_OG_KN");
  rollo_lock(4, 0, "RO_OG_KN");
  rollo_lock(6, 100, "RO_OG_KN");
  simple(0, 3, "LI_OG_KS");
  simple(12, 3, "LI_OG_KS_L1");
  long_short(2, 0, "DF_OG_KS", "VD_OG_KS");
  long_short(3, 100, "DF_OG_KS", "VD_OG_KS");
